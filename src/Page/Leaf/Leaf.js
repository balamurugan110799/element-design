...
function Leaf() {
    ...
    return (
        <div className={`${sessions.sessions === "summer" ? "background-green" : sessions.sessions === "winter" ? "backround-winter" : sessions.sessions === "spring" ? "background-spring" : sessions.sessions === "autumn" ? "background-autumn" : " "} background relative`}>
                ...
                <div className="grid py-4 lg:grid-cols-2 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1">
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 gap-4">
                        <div>
                            <label className=" cursor-pointer">
                                <div className="bg-primary hover:bg-ash-blue duration-300 px-4 py-2 border-design text-white">
                                    <input id="summer" type="radio" value="summer" onChange={(e) => handleChange(e)} name="sessions" className="mr-2" />Summer
                                </div>
                            </label>
                        </div>
                        ...
                        <div>
                            <label className=" cursor-pointer">
                                <div className="bg-primary hover:bg-ash-blue duration-300 px-4 py-2 border-design text-white">
                                    <input type="radio" value="winter" onChange={(e) => handleChange(e)} name="sessions" className="mr-2" />Winter
                                </div>
                            </label>
                        </div>
                        <div>
                            <label className=" cursor-pointer">
                                <div className="bg-primary hover:bg-ash-blue duration-300 px-4 py-2 border-design text-white">
                                    <input type="radio" value="spring" onChange={(e) => handleChange(e)} name="sessions" className="mr-2" />Spring
                                </div>
                            </label>
                        </div>
                        <div>
                            <label className=" cursor-pointer">
                                <div className="bg-primary hover:bg-ash-blue duration-300 px-4 py-2 border-design text-white">
                                    <input type="radio" value="autumn" onChange={(e) => handleChange(e)} name="sessions" className="mr-2" />Autumn
                                </div>
                            </label>
                        </div>
                    </div>
